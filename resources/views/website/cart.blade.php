...
<!-- Slider Area -->
			...
			<div class="row">
				<div class="col-12">
					...
					<table class="table shopping-summery">
						...
						<tbody>
							<tr>
								<td class="image" data-title="No"><img src="{{ asset('website/images/81.jpg') }}" alt="#"></td>
							...
							<tr>
								<td class="image" data-title="No"><img src="{{ asset('website/images/82.jpg') }}" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">Women Dress</a></p>
									<p class="product-des">Maboriosam in a tonto nesciung eget  distingy magndapibus.</p>
								</td>
							...
							<tr>
								<td class="image" data-title="No"><img src="{{ asset('website/images/83.jpg') }}" alt="#"></td>
								<td class="product-des" data-title="Description">
									<p class="product-name"><a href="#">Women Dress</a></p>
									<p class="product-des">Maboriosam in a tonto nesciung eget  distingy magndapibus.</p>
								</td>
	...
	<!--/ End Shopping Cart --> Shopping Cart -->
