								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											...
											<select name="country_name" id="country" class="country-select">
									...
									<div class="col-12">
											...
											<input class="btn submit-btn" type="submit" value="Create an Account">
					...
					<div class="col-lg-4 col-12">
						<div class="order-details">
							...
							<div class="single-widget payement">
								<div class="content">
									<img src="{{ asset('website/images/payment-method.png') }}" alt="#">
								</div>
							</div>
							...
							<div class="single-widget get-button">
								<div class="content">
									<div class="button">
										<a href="{{ route('check.out') }}" class="btn">proceed to checkout</a>
									</div>
								</div>
							</div>
							<!--/ End Button Widget -->
